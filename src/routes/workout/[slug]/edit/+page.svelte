<script lang="ts">
  ...
  function saveWorkout() {
    ...
    goto(`/workout/${encodeURIComponent(workoutToSave.name)}`);
  }
...
<div class="container">
  {#if workout}
    <input class="workout-name-input" bind:value={workout.name} />

    <div class="actions">
        <button on:click={saveWorkout} class="button button-save">Save</button>
